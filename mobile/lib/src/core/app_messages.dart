class AppMessages {
  ...
  static const invalidSelectedSite = 'Selected site no longer exists on the server.';
  ...
  static const wifiUnavailable = 'No Wi-Fi metadata is available from the device right now.';
